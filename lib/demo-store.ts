...
export const defaultProducts: Product[] = [
  ...
  },
  {
    ...
    image: "/www/photos/team/01.jpg",
    imagesByColor: {
      "Серый": ["/www/photos/team/01.jpg", "/www/photos/team/02.jpg", "/www/photos/team/03.jpg"],
  ...
  },
  {
    ...
    imagesByColor: {
      ...
      "Чёрный": ["/www/photos/team/15.jpg", "/www/photos/team/16.jpg", "/www/photos/team/17.jpg"]
    },
    customizable: true,
    skuCode: "03",
    cityPrints: defaultCityPrints,
  ...
  },
  {
    ...
    price: 68900,
    colors: ["Темно-синий", "Оливковый"],
    sizes: ["S", "M", "L"],
    position: "Верхняя одежда",
    image: "/www/photos/team/22.jpg",
    imagesByColor: {
      "Темно-синий": ["/www/photos/team/22.jpg", "/www/photos/team/11.jpg"],
      "Оливковый": ["/www/photos/team/10.jpg", "/www/photos/team/09.jpg"]
    },
    customizable: true,
    skuCode: "08",
    cityPrints: defaultCityPrints,
